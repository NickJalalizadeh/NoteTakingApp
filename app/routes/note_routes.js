...
module.exports = function(app, db) {
    ...
    //Creating a Note
    app.post('NoteTakingApp/notes', (req, res) => {
        // Validate request
    ...
    //Reading one Note
    app.get('NoteTakingApp/notes/:id', (req, res) => {
    ...
    //Reading all Notes
    app.get('NoteTakingApp/notes', (req, res) => {
    ...
    //Updating a Note
    app.put('NoteTakingApp/notes/:id', (req, res) => {
        // Define Note
        const note = defineNote(req.body);
    ...
    //Deleting a Note
    app.delete('NoteTakingApp/notes/:id', (req, res) => {
        const id = req.params.id;
        const details = { '_id': new ObjectID(id) };
